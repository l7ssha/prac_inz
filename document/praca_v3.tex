...
Zostało przygotowane również oprogramowanie, które steruje pracą mikrokontrolera - urządzenia udostępnia interfejs www dla użytkownika, interfejs programowy REST API oraz integracje z MQTT. 
